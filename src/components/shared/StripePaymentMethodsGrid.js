...
const SPMGrid = props => {
  const grid_items = [
    {value:"card", label:"cards", background:'url(https://cdn.tabme.io/app-public-assets/credit-card-regular.svg) 50% 0 / 45px no-repeat transparent'},
    {value:"giropay", label:"Giropay", background:'url(https://cdn.tabme.io/app-public-assets/giropay.svg) 50% 0 / 45px no-repeat transparent'},
    {value:"ideal", label:"iDeal", background:'url(https://cdn.tabme.io/app-public-assets/ideal.svg) 50% 0 / 45px no-repeat transparent'},
    {value:"bancontact", label:"Bancontact", background:'url(https://cdn.tabme.io/app-public-assets/bancontact.svg) 50% 0 / 50px no-repeat transparent'},
    {value:"wallet", label:"wallets", background:'url("https://cdn.tabme.io/app-public-assets/applepay.svg") 25% 30% / 30px no-repeat, url("https://cdn.tabme.io/app-public-assets/gpay.svg") 70% 30% / 30px no-repeat'},
  ];
...
return(<GridWrapper>
            ...
            {grid_items.map((item, idx)=>{
                return  <GridItem onClick={()=>changeStripeMethod(item.value)} key={item.value} id={item.value}>
